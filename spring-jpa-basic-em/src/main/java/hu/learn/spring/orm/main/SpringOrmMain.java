package hu.learn.spring.orm.main;
...
import hu.learn.spring.orm.service.ProductService;
...
//		productService.add(new Product(1, "Laptop"));
//		productService.add(new Product(2, "Licence Eclipse"));
